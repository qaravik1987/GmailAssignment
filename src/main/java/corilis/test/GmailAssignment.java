...
public class GmailAssignment {
	...
	public static void main(String[] args) {
		...
		_gmailAssignment
				.loginIntoGmail("qaravik1987@gmail.com", "test12345678");
	...
	public void loginIntoGmail(String userID, String pwd) {
		...
		WebElement compose = driver.findElement(By
				.cssSelector("div[class^='T-I'][role='button'][gh='cm']"));
		...
		List<WebElement> addCC = driver.findElements(By
				.cssSelector("span[data-tooltip^='Add']"));
		...
		WebElement mailBody = driver.findElement(By
				.cssSelector("div[class^='Am']"));
		mailBody.sendKeys(content);
		WebElement send = driver.findElement(By
				.cssSelector("div[role='button'][data-tooltip^='Send']"));
		send.click();
	}
